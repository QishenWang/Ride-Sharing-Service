...
class Ride(models.Model):
    ...
    ride_driver_id = models.ForeignKey(User,
                                       ...
                                       on_delete=models.CASCADE,
                                       null=True)
    ride_sharer1_id = models.ForeignKey(User,
                                        related_name='Sharer_1',
                                        on_delete=models.CASCADE,
                                        null=True)
    ride_sharer2_id = models.ForeignKey(User,
                                        related_name='Sharer_2',
                                        on_delete=models.CASCADE,
                                        null=True)
    ride_sharer3_id = models.ForeignKey(User,
                                        related_name='Sharer_3',
                                        on_delete=models.CASCADE,
                                        null=True)
    ride_sharer4_id = models.ForeignKey(User,
